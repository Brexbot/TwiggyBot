...
export const classes: CharacterClass[] = [
  { name: 'artificer', statPreferences: ['INT', 'WIS', 'DEX', 'CHR', 'CON', 'STR'] },
  { name: 'barbarian', statPreferences: ['STR', 'CON', 'DEX', 'CHR', 'WIS', 'INT'] },
  { name: 'bard', statPreferences: ['CHR', 'WIS', 'INT', 'DEX', 'CON', 'STR'] },
  { name: 'cleric', statPreferences: ['WIS', 'CHR', 'CON', 'STR', 'DEX', 'INT'] },
  { name: 'druid', statPreferences: ['WIS', 'INT', 'STR', 'CON', 'DEX', 'CHR'] },
  { name: 'fighter', statPreferences: ['DEX', 'STR', 'CON', 'CHR', 'INT', 'WIS'] },
  { name: 'monk', statPreferences: ['DEX', 'CHR', 'STR', 'WIS', 'CON', 'INT'] },
  { name: 'paladin', statPreferences: ['CHR', 'STR', 'INT', 'CON', 'WIS', 'DEX'] },
  { name: 'ranger', statPreferences: ['DEX', 'WIS', 'INT', 'CON', 'CHR', 'STR'] },
  ...
  { name: 'thief', statPreferences: ['DEX', 'CHR', 'WIS', 'INT', 'STR', 'CON'] },
  { name: 'motorcycle knight', statPreferences: ['DEX', 'CHR', 'STR', 'CON', 'INT', 'WIS'] },
  { name: 'bardbarian', statPreferences: ['STR', 'CHR', 'CON', 'DEX', 'WIS', 'INT'] },
  { name: 'person-at-Arms', statPreferences: ['CON', 'STR', 'DEX', 'CHR', 'INT', 'WIS'] },
  { name: 'librarian', statPreferences: ['INT', 'CHR', 'WIS', 'DEX', 'CON', 'STR'] },
  { name: 'jedi', statPreferences: ['DEX', 'WIS', 'CHR', 'CON', 'STR', 'INT'] },
  { name: 'strangler', statPreferences: ['DEX', 'STR', 'INT', 'WIS', 'CON', 'CHR'] },
  ...
  { name: 'valkyrie', statPreferences: ['DEX', 'STR', 'CON', 'WIS', 'INT', 'CHR'] },
  ...
  { name: 'chaotician', statPreferences: ['WIS', 'INT', 'CHR', 'DEX', 'STR', 'CON'] },
  { name: 'prankster', statPreferences: ['CHR', 'DEX', 'WIS', 'INT', 'STR', 'CON'] },
  { name: 'anarchist', statPreferences: ['CHR', 'INT', 'STR', 'CON', 'DEX', 'WIS'] },
  { name: 'pacifist', statPreferences: ['CHR', 'WIS', 'INT', 'CON', 'DEX', 'STR'] },
  ...
  { name: 'potwash', statPreferences: ['DEX', 'WIS', 'CON', 'INT', 'CHR', 'STR'] },
